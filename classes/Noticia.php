...
class Noticia{
    ...
    public function comentar(){
        ...
        if($comentario->salvar($_POST['noticia_id'], $_POST['comentario'], $_POST['nome_usuario'])($noticia_id, $comentario, $nome_usuario)){
            $msg['msg']="Notícia comentada com sucesso!";
            $msg['class']="success";
            $_SESSION['msg']=$msg;
        }else{
            $msg['msg']="Falha ao comentar a notícia!";
            $msg['class']="danger";
            $_SESSION['msg']=$msg;   
        }
